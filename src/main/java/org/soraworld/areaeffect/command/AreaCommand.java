...
public class AreaCommand extends ICommand implements net.minecraft.command.ICommand {
    ...
    public int compareTo(net.minecraft.command.ICommand command) {
        if (command instanceof AreaCommand && command.func_71517_b().equals(this.func_71517_b())) {
            return 0;
        } else {
            return 1;
        }
...
/*
    public int compareTo(Object object) {
        if (object instanceof AreaCommand && ((AreaCommand) object).getName().equals(this.getName())) return 0;
        else return 1;
    }
*/
}
