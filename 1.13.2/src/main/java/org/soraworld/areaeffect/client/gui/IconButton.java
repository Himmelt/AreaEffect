    ...
    private void drawGlyph(int color) {
        ...
        switch (glyph) {
            ...
            case GLYPH_WIRE: {
                ...
                int r = gx + s - 1 - in;
                int b = gy + s - 1 - in;
                drawRect(gx + in, gy + in, r + 1, gy + in + 1, a);
                drawRect(gx + in, b, r + 1, b + 1, a);
                drawRect(gx + in, gy + in, gx + in + 1, b + 1, a);
                drawRect(r, gy + in, r + 1, b + 1, a);
                if (on) {
                    drawRect(gx + in + 1, gy + in + 1, r, b, a);
                }
                break;
            }
            case GLYPH_SAVE: {
