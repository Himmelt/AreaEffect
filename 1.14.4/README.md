...
/areaeffect list [all|<dim>]             列出(<dim>维度世界的)所有区域，没有参数时为玩家所在世界，参数为all时为全部世界
...
/areaeffect list [all|<dim>]             list dimension <dim> world's areas, empty args using player's world, arg "all" will list all world's areas
