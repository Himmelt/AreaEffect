...
public final class EffectTypes {
     ...
     */
    public static AreaEffect fromNbt(CompoundNBT tag) {
    ...
    private static LightnessEffect readLightnessNbt(CompoundNBT tag) {
    ...
    private static FogEffect readFogNbt(CompoundNBT tag) {
    ...
    private static SkyEffect readSkyNbt(CompoundNBT tag) {
