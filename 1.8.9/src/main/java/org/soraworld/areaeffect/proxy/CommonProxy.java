...
public class CommonProxy {
    ...
    public void onPreInit(FMLPreInitializationEvent event) {
        net.minecraftforge.fml.common.FMLCommonHandler.instance().bus().register(new FMLHandler(this));
    }
    ...
    public void updateCUI(EntityPlayerMP player) {
        ...
        player.playerNetServerHandler.sendPacket((Packet) new S3FPacketCustomPayload(WECUI_CHANNEL, new PacketBuffer(Unpooled.copiedBuffer(CUBOID))));
        player.playerNetServerHandler.sendPacket((Packet) new S3FPacketCustomPayload(WECUI_CHANNEL, new PacketBuffer(Unpooled.copiedBuffer(pos1.cui(1, size)))));
        player.playerNetServerHandler.sendPacket((Packet) new S3FPacketCustomPayload(WECUI_CHANNEL, new PacketBuffer(Unpooled.copiedBuffer(pos2.cui(2, size)))));
    }
