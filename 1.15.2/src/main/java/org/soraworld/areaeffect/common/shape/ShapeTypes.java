...
public final class ShapeTypes {
    ...
    public static AreaShape fromNbt(CompoundNBT tag) {
        if (tag == null) {
            return null;
        }
        try {
    ...
    /** 序列化到 NBT。 */
    public static void writeNbt(AreaShape shape, CompoundNBT tag) {
    ...
    private static AreaShape dispatch(String type, ByteBuf buf, CompoundNBT tag) {
